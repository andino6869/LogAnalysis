...
#from logfile_definition2 import get_dataframe_and_columns
from logfile_definition2 import load_data_parallel
from logfile_definition2 import load_single_file

#df, modified_columns = get_dataframe_and_columns()
columns = []
modified_columns = load_data_parallel(columns)
final_df = load_single_file()
