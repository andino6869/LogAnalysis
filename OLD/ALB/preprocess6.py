...
columns_to_drop = ["proto", "elb", "target_status", "client:port", "target:port","r_url", "response_processing_time",
                   "response_processing_time", "user_agent", "ssl_cipher", "ssl_protocol", "target_group_arn", "s_bytes",
