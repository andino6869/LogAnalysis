...
columns = [
    "proto", "timestamp", "elb", "client:port", "target:port", "request_processing_time", "latency", "response_processing_time", "status", "target_status", "r_bytes", "s_bytes",
...
columns_to_drop = [
    "proto", "timestamp", "elb", "client:port", "client", "target:port", "request_processing_time", "response_processing_time", "target_group_arn", "s_bytes","request", "target_status", 
